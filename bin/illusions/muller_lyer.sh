...
# CONVNEXT="convnext_xlarge.fb_in22k_ft_in1k"
...
uv run python -m scripts.illusions.muller_lyer \
  --annotations "data/datasets/full/visual_illusions/muller_lyer_illusion/annotation.csv" \
